...
globals.utils.deepCopy = function(object) {
  return JSON.parse(JSON.stringify(object));
};

globals.utils.destroy = function(obj) {
  for (var key in obj) {
...
globals.utils.getRandomColor = function() {
...
globals.utils.isView = function(view) {
  return globals.strings.viewTitles[view] !== undefined;
};

globals.utils.setAlpha = function(color, alpha) {
  var attrs = color.split(',');
  attrs[3] = alpha.toString() + ')';
  return attrs.join(",");
};

globals.utils.spanLen = function(span) {
...
globals.utils.windowCheck = function() {
    mobileDevice = false;
