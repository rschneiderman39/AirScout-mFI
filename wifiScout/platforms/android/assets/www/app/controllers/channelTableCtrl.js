app.controller('channelTableCtrl', ['$scope', 'channelTableData',
  'utils', 'cordovaService', function($scope, channelTableData,
  utils, cordovaService) {
    cordovaService.ready.then(
      function resolved() {
        var X_DOMAIN_2_4 = channelTableData.getDomain('2_4Ghz'),
            X_DOMAIN_5 = channelTableData.getDomain('5Ghz'),
            Y_DOMAIN = channelTableData.getRange(),
            FILL_ALPHA = 0.2,
            LABEL_PADDING = 10,
        ...
        var init = function() {
          ...
          buildPlot();
          buildNav();
          $scope.setBand(channelTableData.band());
        ...
        var update = function() {
          var data = channelTableData.generate();
        ...
        var buildNav = function() {
          ...
          elem.nav.right.viewport = d3.svg.brush()
            ...
            .extent(channelTableData.sliderExtent())
        ...
        var storeSettings = function() {
          channelTableData.band(band);
          channelTableData.sliderExtent(elem.nav.right.viewport.extent());
        };
