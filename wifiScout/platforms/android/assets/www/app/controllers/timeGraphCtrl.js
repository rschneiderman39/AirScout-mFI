app.controller('timeGraphCtrl', ['$scope', 'APService', 'filterService',
	'cordovaService', function($scope, APService, filterService, cordovaService) {
        ...
        $scope.updateData = function() {
          ...
          $scope.data =  [
              [86, 81, 12, 1, 82, 4, 42, 69, 36, 16, 13, 88, 67, 56, 26, 70, 35, 7, 86],
              [16, 57, 66, 35, 33, 47, 59, 28, 81, 70, 33, 1, 4, 60, 8, 21, 43, 56, 16], 
              [50, 7, 55, 26, 37, 51, 60, 61, 86, 79, 66, 78, 5, 57, 31, 36, 55, 16, 50], 
              [3, 60, 90, 76, 71, 27, 81, 77, 89, 44, 4, 13, 6, 46, 34, 61, 68, 76, 3],
              [12, 88, 15, 6, 87, 88, 15, 25, 20, 74, 43, 16, 67, 79, 33, 84, 10, 37, 12],
              [76, 71, 10, 32, 15, 69, 26, 13, 37, 63, 39, 79, 52, 1, 31, 39, 16, 6, 76]
            ];
          }
        }
